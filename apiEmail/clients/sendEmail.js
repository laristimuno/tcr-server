...
const sendEmail = async (infoUser) => {
  ...
  <div width='100%'>
    ...
    <div style="margin-bottom:40px">
      <a href="https://tcrbuilders.com/client-dashboard" style="display:block;text-align:center;background-color:#ea6326;padding:10px;max-width:150px;margin:auto;color:#fff;text-transform:uppercase;text-decoration:none;border-radius: 10px;">My Account</a>
    </div>
  </div>
  <div>
